...
class LatestRevisionCheckTest extends UnitTestCase {
   ...
   */
  public function testLatestAccessPermissions($entity_class, $entity_type, $bundle, $has_pending_revision, array $account_permissions, $is_owner, $result_class) {
    ...
    $possible_permissions = [
      ...
      "view any unpublished $entity_type:$bundle content",
    ];
  ...
  public function accessSituationProvider() {
    return [
      ...
      [Node::class, 'node', 'article', TRUE, ['view latest version', 'view any unpublished content'], FALSE, AccessResultAllowed::class],
      // Node with global permissions and no latest version.
      [Node::class, 'node', 'article', FALSE, ['view latest version', 'view any unpublished content'], FALSE, AccessResultForbidden::class],
      // Node with own content permissions and latest version.
      [Node::class, 'node', 'article', TRUE, ['view latest version', 'view own unpublished content'], TRUE, AccessResultAllowed::class],
      // Node with own content permissions and no latest version.
      [Node::class, 'node', 'article', FALSE, ['view latest version', 'view own unpublished content'], FALSE, AccessResultForbidden::class],
      // Node with own content permissions and latest version, but no perms to
      // view latest version.
      [Node::class, 'node', 'article', TRUE, ['view own unpublished content'], TRUE, AccessResultNeutral::class],
      // Node with own content permissions and no latest version, but no perms
      // to view latest version.
      [Node::class, 'node', 'article', TRUE, ['view own unpublished content'], FALSE, AccessResultNeutral::class],
      // Node with bundle-specific permissions.
      [Node::class, 'node', 'article', TRUE, ['view latest version', 'view any unpublished node:article content'], FALSE, AccessResultAllowed::class],
      // Node with bundle-specific permissions, but no permission to view latest version.
      [Node::class, 'node', 'article', TRUE, ['view any unpublished node:article content'], FALSE, AccessResultNeutral::class],
      // Block with pending revision, and permissions to view any.
      [BlockContent::class, 'block_content', 'basic', TRUE, ['view latest version', 'view any unpublished content'], FALSE, AccessResultAllowed::class],
      // Block with no pending revision.
      [BlockContent::class, 'block_content', 'basic', FALSE, ['view latest version', 'view any unpublished content'], FALSE, AccessResultForbidden::class],
      // Block with pending revision, but no permission to view any.
      [BlockContent::class, 'block_content', 'basic', TRUE, ['view latest version', 'view own unpublished content'], FALSE, AccessResultNeutral::class],
      // Block with no pending revision.
      [BlockContent::class, 'block_content', 'basic', FALSE, ['view latest version', 'view own unpublished content'], FALSE, AccessResultForbidden::class],
    ];
  }
